...
function DataMatrixDecode() {
    ...
    const ReaderOnload = (e: ProgressEvent<FileReader>) => {
        ...
        codeReader.decodeFromImageUrl(imageUrl)
            ...
            .catch((err) => {
                ...
                window.alert("DataMatrixのデコードに失敗しました")
            })
    }
    ...
    return(
        <div className="main">
            ...
            <div className="result" style={{display: isResultRead ? "block": "none"}}>
                {image && <img src={image} alt="Uploaded Preview" className="preview" />}
                <div className="result_reader" style={{display: isResultText ? "inline-flex" : "none"}}>
...
export default DataMatrixDecode;
